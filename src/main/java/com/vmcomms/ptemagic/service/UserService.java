...
import com.vmcomms.ptemagic.repository.AuthorityRepository;
...
public class UserService {
    ...
    public User creatPteAccount(RegisterUserVM userDTO) {
        ...
        User newUser = new User();
        Authority authority = authorityRepository.findOne(AuthoritiesConstants.FREE_MEMBER);
        Set<Authority> authorities = new HashSet<>();
        String encryptedPassword = passwordEncoder.encode(userDTO.getPassword());
        newUser.setLogin(userDTO.getEmail());
//        newUser.setLogin("user" + System.currentTimeMillis());
        // new user gets initially a generated password
        newUser.setPassword(encryptedPassword);
