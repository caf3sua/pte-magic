...
public class UserResource {
    ...
    public UserResource(UserRepository userRepository, UserService userService, MailService mailService, ExamService examService) {
...
//    }
    ...
    public ResponseEntity<Void> deleteUser(@PathVariable Long id) {
        ...
        userRepository.deletePteUser(id);
        
        // Delete exam by id
        examService.deleteByUserId(id);
